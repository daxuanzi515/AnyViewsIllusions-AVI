...
| ------------------------------ | ------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **CLIP-A (Alignment Score)**   | Ranked **1st in 2 out of 9** cases, and shows consistently strong results in most examples                   | Indicates good alignment with intended prompts — the generated view accurately reflects its assigned semantic content                                                             |
